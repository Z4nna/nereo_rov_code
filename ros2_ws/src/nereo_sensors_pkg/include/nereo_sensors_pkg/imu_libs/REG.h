...
#define MMSS		       0x32
#define MS			       0x33
/// Defines the register address for the accelerations.
#define AX 0x34
#define AY 0x35
#define AZ 0x36
/// Defines the register address for the angular velocity data.
#define GX 0x37
#define GY 0x38
#define GZ 0x39
#define HX 0x3a
#define HY			       0x3b
#define HZ			       0x3c
/// Defines the register address for roll, pitch, and yaw data.
#define Roll		       0x3d
#define Pitch		       0x3e
#define Yaw			       0x3f
#define TEMP		       0x40
